...
const translations = {
  en: {
    ...
    withdraw: {
      title: "Withdraw USDT",
      subtitle: "Send USDT to your TRC-20 wallet address.",
  ...
  fr: {
    ...
    withdraw: {
      title: "Retirer USDT",
      subtitle: "Envoyez des USDT vers votre adresse TRC-20.",
  ...
  ht: {
    ...
    withdraw: {
      title: "Retire Lajan",
      subtitle: "Voye USDT nan adr\u00e8s TRC-20 ou.",
      ...
      trcAddressHint: "Voye sou\u00e8lman nan yon adr\u00e8s TRC-20 valab. Adr\u00e8s enkòr\u00e8k ka koze pèt pèmanan fon.",
      fee: "Fr\u00e8 rezo",
