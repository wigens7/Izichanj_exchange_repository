...
const translations = {
  en: {
    ...
    deposit: {
      ...
      moncashTitle: "MonCash / NatCash Deposit",
      moncashSubtitle: "Send payment to our company account and submit proof for review.",
      moncashAmount: "Amount to Deposit (HTG)",
      moncashAmountPlaceholder: "e.g. 2000",
      moncashMinimum: "Minimum: 1,430 HTG (10 USDT)",
      moncashPayButton: "Submit Deposit",
      moncashComingSoon: "Coming Soon",
      moncashComingSoonDesc: "MonCash deposits will be available shortly.",
      methodNatcash: "NatCash",
      manualWalletLabel: "Select Mobile Wallet",
      manualSendTo: "Send your payment to:",
      manualTxId: "Transaction ID",
      manualTxIdPlaceholder: "Enter the transaction ID from your MonCash/NatCash receipt",
      manualProof: "Upload Payment Screenshot",
      manualProofDesc: "Attach a screenshot of your payment confirmation",
      manualProofUploaded: "Screenshot uploaded",
      manualProofUploading: "Uploading...",
    ...
    withdraw: {
      ...
      subtitle: "Send USDT to your TRC-20 wallet or cash out to MonCash / NatCash.",
      tabMobileMoney: "Mobile Money",
      tabUsdtTrc20: "USDT TRC-20",
      securityVerification: "Security Notice",
      securityDescription: "Withdrawals are reviewed and processed within 15–60 minutes by our team.",
      amountUsdt: "Amount (USDT)",
      walletType: "Wallet",
      selectWallet: "Select wallet",
      htgEquivalent: "HTG Equivalent",
      exchangeRate: "Withdrawal Rate",
      ...
      qrCodeDescription: "Upload your MonCash/NatCash QR code image.",
      ...
      trcAddress: "TRC-20 Wallet Address",
      trcAddressPlaceholder: "Enter your USDT TRC-20 address (e.g. T...)",
      trcAddressHint: "Only send to a valid USDT TRC-20 (Tron) address. Incorrect addresses may result in permanent loss of funds.",
      fee: "Network Fee",
      totalDeducted: "Total to Deduct",
      withdrawalPin: "6-Digit Withdrawal PIN",
      withdrawalPinPlaceholder: "••••••",
      withdrawalPinHint: "Enter your 6-digit withdrawal authorization PIN.",
      noPinSet: "You have not set a Withdrawal PIN yet.",
      noPinAction: "Set it up in Security Settings before withdrawing.",
      ...
      pinError: "Withdrawal PIN must be exactly 6 digits",
      trcAddressError: "Please enter a valid TRC-20 wallet address",
      underReview: "Under Review",
      tosTitle: "Terms of Service — Withdrawals",
      tosText: "Mwen konprann ke retrè USDT yo trete sou rezo TRC-20 (Tron). Montan an ak frè yo déduit imedyatman nan balans mwen. Izichanj pa responsab pou fon ki pèdu akòz adrès enkòrèk. Retrè yo trete nan 15 a 60 minit. Limit chak jou a se 10,000 USDT.",
      tosAgree: "I agree to the Terms and Conditions",
      minLimit: "Min",
      maxLimit: "Max/day",
    },
    profile: {
      ...
      referenceId: "Your ID",
      referenceIdDescription: "Share this ID to receive funds from other users",
      copied: "Copied!",
      copiedDesc: "Reference ID copied to clipboard",
    },
    transfer: {
      title: "Send Funds",
      subtitle: "Send USDT to another Izichanj user instantly",
      recipientLabel: "Recipient",
      recipientPlaceholder: "Enter user ID, email, or phone number",
      lookupButton: "Find User",
      looking: "Searching...",
      recipientFound: "Recipient Found",
      amount: "Amount (USDT)",
      amountPlaceholder: "Enter amount",
      note: "Note (optional)",
      notePlaceholder: "Add a message for the recipient",
      yourBalance: "Your Balance",
      sendButton: "Send Funds",
      sending: "Sending...",
      success: "Transfer Successful",
      successDesc: "Funds have been sent successfully",
      minAmount: "Minimum 1 USDT",
      ...
      kycRequiredDesc: "You must complete identity verification before sending funds.",
    },
    receipt: {
      title: "Receipt",
    ...
    virtualCard: {
      ...
      subtitle: "Apply for a virtual Mastercard to make online payments worldwide.",
      applyTitle: "Apply for Card",
      applyDescription: "Get your virtual Mastercard with an initial $4.00 balance for a total of $19.00.",
      initialFunding: "Initial Funding (USD)",
      minFunding: "Minimum $19.99 USD",
      applyButton: "Apply for Mastercard",
      ...
      cvv: "CVV",
      noTransactions: "No transactions yet.",
      kycRequired: "KYC verification is required to apply for a Mastercard.",
      kycRequiredDesc: "Complete your KYC verification to apply for a Mastercard.",
      cardCreated: "Mastercard created successfully!",
      cardFunded: "Card funded successfully!",
      frozen: "Frozen",
      active: "Active",
      cardCost: "Card Cost",
      yourBalance: "Your Balance",
      insufficientBalance: "You don't have enough USDT in your account to apply for a virtual card. Please deposit funds first.",
      maintenanceTitle: "Under Maintenance",
      maintenanceDesc: "Mastercard service is currently under maintenance. Please try again later.",
    },
    faq: {
  ...
  fr: {
    ...
    deposit: {
      ...
      moncashTitle: "Dépôt MonCash / NatCash",
      moncashSubtitle: "Envoyez votre paiement à notre compte et soumettez une preuve pour examen.",
      moncashAmount: "Montant à déposer (HTG)",
      moncashAmountPlaceholder: "ex. 2000",
      moncashMinimum: "Minimum: 1 430 HTG (10 USDT)",
      moncashPayButton: "Soumettre le dépôt",
      moncashComingSoon: "Bientôt disponible",
      moncashComingSoonDesc: "Les dépôts MonCash seront disponibles sous peu.",
      methodNatcash: "NatCash",
      manualWalletLabel: "Sélectionner le portefeuille",
      manualSendTo: "Envoyez votre paiement à :",
      manualTxId: "ID de transaction",
      manualTxIdPlaceholder: "Entrez l'ID de transaction de votre reçu MonCash/NatCash",
      manualProof: "Télécharger la capture d'écran",
      manualProofDesc: "Joignez une capture d'écran de votre confirmation de paiement",
      manualProofUploaded: "Capture téléchargée",
      manualProofUploading: "Téléchargement...",
    ...
    withdraw: {
      ...
      subtitle: "Envoyez des USDT vers TRC-20 ou retirez vers MonCash / NatCash.",
      tabMobileMoney: "Mobile Money",
      tabUsdtTrc20: "USDT TRC-20",
      securityVerification: "Avis de s\u00e9curit\u00e9",
      securityDescription: "Les retraits sont examin\u00e9s et trait\u00e9s dans les 15 \u00e0 60 minutes.",
      amountUsdt: "Montant (USDT)",
      walletType: "Portefeuille",
      selectWallet: "S\u00e9lectionner",
      htgEquivalent: "\u00c9quivalent HTG",
      exchangeRate: "Taux de retrait",
      youWillReceive: "Vous recevrez",
      withdrawMethod: "M\u00e9thode",
      phoneMethod: "Num\u00e9ro de t\u00e9l\u00e9phone",
      qrCodeMethod: "Code QR",
      phoneNumber: "Num\u00e9ro de t\u00e9l\u00e9phone",
      qrCodeUpload: "T\u00e9l\u00e9charger le code QR",
      qrCodeDescription: "T\u00e9l\u00e9chargez le code QR de votre portefeuille.",
      ...
      trcAddress: "Adresse de portefeuille TRC-20",
      trcAddressPlaceholder: "Entrez votre adresse USDT TRC-20 (ex. T...)",
      trcAddressHint: "Envoyez uniquement vers une adresse TRC-20 valide. Une adresse incorrecte peut entra\u00eener une perte d\u00e9finitive des fonds.",
      fee: "Frais de r\u00e9seau",
      totalDeducted: "Total \u00e0 d\u00e9duire",
      withdrawalPin: "PIN de retrait \u00e0 6 chiffres",
      withdrawalPinPlaceholder: "\u2022\u2022\u2022\u2022\u2022\u2022",
      withdrawalPinHint: "Entrez votre PIN d'autorisation de retrait \u00e0 6 chiffres.",
      noPinSet: "Vous n'avez pas encore d\u00e9fini de PIN de retrait.",
      noPinAction: "Configurez-le dans les param\u00e8tres de s\u00e9curit\u00e9 avant de retirer.",
      ...
      pinError: "Le PIN de retrait doit contenir exactement 6 chiffres",
      trcAddressError: "Veuillez entrer une adresse TRC-20 valide",
      underReview: "En cours d'examen",
      tosTitle: "Conditions — Retraits",
      tosText: "Mwen konprann ke retr\u00e8 USDT yo trete sou rezo TRC-20 (Tron). Montan an ak fr\u00e8 yo d\u00e9duit imedyatman nan balans mwen. Izichanj pa responsab pou fon ki p\u00e8du ak\u00f2z adr\u00e8s enk\u00f2r\u00e8k. Retr\u00e8 yo trete nan 15 a 60 minit. Limit chak jou a se 10,000 USDT.",
      tosAgree: "J'accepte les conditions",
      minLimit: "Min",
      maxLimit: "Max/jour",
    },
    profile: {
      ...
      referenceId: "Votre ID",
      referenceIdDescription: "Partagez cet ID pour recevoir des fonds d'autres utilisateurs",
      copied: "Copi\u00e9 !",
      copiedDesc: "ID de r\u00e9f\u00e9rence copi\u00e9 dans le presse-papiers",
    },
    transfer: {
      title: "Envoyer des fonds",
      subtitle: "Envoyez des USDT \u00e0 un autre utilisateur Izichanj instantan\u00e9ment",
      recipientLabel: "Destinataire",
      recipientPlaceholder: "Entrez l'ID, l'email ou le num\u00e9ro de t\u00e9l\u00e9phone",
      ...
      note: "Note (optionnel)",
      notePlaceholder: "Ajoutez un message pour le destinataire",
      yourBalance: "Votre solde",
      sendButton: "Envoyer",
      sending: "Envoi en cours...",
      success: "Transfert r\u00e9ussi",
      successDesc: "Les fonds ont \u00e9t\u00e9 envoy\u00e9s avec succ\u00e8s",
      minAmount: "Minimum 1 USDT",
      ...
      kycRequiredDesc: "Vous devez compl\u00e9ter la v\u00e9rification d'identit\u00e9 avant d'envoyer des fonds.",
    },
    receipt: {
      title: "Re\u00e7u",
      deposit: "D\u00e9p\u00f4t USDT",
    ...
    virtualCard: {
      ...
      subtitle: "Demandez une Mastercard virtuelle pour effectuer des paiements en ligne dans le monde entier.",
      applyTitle: "Demander une carte",
      applyDescription: "Obtenez votre Mastercard virtuelle avec un solde initial de 4,00 $ pour un total de 19,00 $.",
      initialFunding: "Financement initial (USD)",
      minFunding: "Minimum 19,99 $ USD",
      applyButton: "Demander une Mastercard",
      ...
      cvv: "CVV",
      noTransactions: "Aucune transaction pour le moment.",
      kycRequired: "La v\u00e9rification KYC est requise pour demander une Mastercard.",
      kycRequiredDesc: "Compl\u00e9tez votre v\u00e9rification KYC pour demander une Mastercard.",
      cardCreated: "Mastercard cr\u00e9\u00e9e avec succ\u00e8s !",
      cardFunded: "Carte recharg\u00e9e avec succ\u00e8s !",
      frozen: "Gel\u00e9e",
      active: "Active",
      cardCost: "Co\u00fbt de la carte",
      yourBalance: "Votre solde",
      insufficientBalance: "Vous avez besoin d'au moins 30 $ USDT sur votre compte pour demander une carte virtuelle. Veuillez d'abord d\u00e9poser des fonds.",
      maintenanceTitle: "En maintenance",
      maintenanceDesc: "Le service Mastercard est actuellement en maintenance. Veuillez r\u00e9essayer plus tard.",
    },
    faq: {
  ...
  ht: {
    ...
    deposit: {
      ...
      moncashTitle: "Depo MonCash / NatCash",
      moncashSubtitle: "Voye peman nan kont konpayi nou epi soumèt prèv pou revizyon.",
      moncashAmount: "Montan pou Depoze (HTG)",
      moncashAmountPlaceholder: "ex. 2000",
      moncashMinimum: "Minimom: 1 430 HTG (10 USDT)",
      moncashPayButton: "Soumèt Depo",
      moncashComingSoon: "Ap vini byento",
      moncashComingSoonDesc: "Depo MonCash ap disponib talè konsa.",
      methodNatcash: "NatCash",
      manualWalletLabel: "Chwazi Bous Mobil",
      manualSendTo: "Voye peman ou a:",
      manualTxId: "ID Tranzaksyon",
      manualTxIdPlaceholder: "Antre ID tranzaksyon nan resi MonCash/NatCash ou a",
      manualProof: "Telechaje Screenshot",
      manualProofDesc: "Atache yon screenshot konfimasyon peman ou a",
      manualProofUploaded: "Screenshot telechaje",
      manualProofUploading: "Ap telechaje...",
    ...
    withdraw: {
      title: "Retire Lajan",
      subtitle: "Voye USDT nan TRC-20 oswa retire nan MonCash / NatCash.",
      tabMobileMoney: "Lajan Mobil",
      tabUsdtTrc20: "USDT TRC-20",
      securityVerification: "Avi sekirite",
      securityDescription: "Retr\u00e8 yo egzamine epi trete nan 15-60 minit.",
      amountUsdt: "Montan (USDT)",
      walletType: "Bous",
      selectWallet: "Chwazi bous",
      htgEquivalent: "Ekivalan HTG",
      exchangeRate: "To retr\u00e8",
      ...
      qrCodeDescription: "Telechaje k\u00f2d QR bous ou pou peman.",
      ...
      trcAddress: "Adr\u00e8s bous TRC-20",
      trcAddressPlaceholder: "Antre adr\u00e8s USDT TRC-20 ou (ex. T...)",
      trcAddressHint: "Voye sou\u00e8lman nan yon adr\u00e8s TRC-20 valab. Adr\u00e8s inkòrèk ka koze pèt pèmanan fon.",
      fee: "Fr\u00e8 rezo",
      totalDeducted: "Total pou d\u00e9dui",
      withdrawalPin: "PIN retr\u00e8 6 chif",
      withdrawalPinPlaceholder: "\u2022\u2022\u2022\u2022\u2022\u2022",
      withdrawalPinHint: "Antre PIN otorizasyon retr\u00e8 6 chif ou.",
      noPinSet: "Ou pa anko defini PIN retr\u00e8 ou.",
      noPinAction: "Mete li kanpe nan Param\u00e8t S\u00e9kirite anvan ou retire.",
      goToSecurity: "Al nan S\u00e9kirite",
      ...
      pinError: "PIN retr\u00e8 dwe gen egzakteman 6 chif",
      trcAddressError: "Tanpri antre yon adr\u00e8s TRC-20 valab",
      underReview: "Anba egzamen",
      tosTitle: "Kondisyon itilizasyon \u2014 Retr\u00e8",
      tosText: "Mwen konprann ke retr\u00e8 USDT yo trete sou rezo TRC-20 (Tron). Montan an ak fr\u00e8 yo d\u00e9duit imedyatman nan balans mwen. Izichanj pa responsab pou fon ki p\u00e8du ak\u00f2z adr\u00e8s enk\u00f2r\u00e8k. Retr\u00e8 yo trete nan 15 a 60 minit. Limit chak jou a se 10,000 USDT.",
      tosAgree: "Mwen dak\u00f2 ak kondisyon yo",
      minLimit: "Min",
      maxLimit: "Max/jou",
    },
    profile: {
      ...
      referenceId: "ID ou",
      referenceIdDescription: "Pataje ID sa a pou resevwa lajan nan men l\u00f2t itilizat\u00e8",
      copied: "Kopye!",
      copiedDesc: "ID ref\u00e9rans kopye nan pano klip",
    },
    transfer: {
      title: "Voye Lajan",
      subtitle: "Voye USDT bay yon l\u00f2t itilizat\u00e8 Izichanj imedyatman",
      recipientLabel: "Destinat\u00e8",
      recipientPlaceholder: "Antre ID, im\u00e8l, oswa nimewo telef\u00f2n",
      lookupButton: "Chache itilizat\u00e8",
      looking: "Ap chache...",
      recipientFound: "Destinat\u00e8 jwenn",
      amount: "Montan (USDT)",
      amountPlaceholder: "Antre montan an",
      note: "N\u00f2t (opsyon\u00e8l)",
      notePlaceholder: "Ajoute yon mesaj pou destinat\u00e8 a",
      yourBalance: "Balans ou",
      sendButton: "Voye Lajan",
      sending: "Ap voye...",
      success: "Transf\u00e8 r\u00e9yisi",
      successDesc: "Lajan an voye av\u00e8k siks\u00e8",
      minAmount: "Minimom 1 USDT",
      insufficientBalance: "Balans ensifizan",
      userNotFound: "Itilizat\u00e8 pa jwenn",
      history: "Istwa transf\u00e8",
      ...
      kycRequiredDesc: "Ou dwe konplete verifikasyon idantite anvan ou voye lajan.",
    },
    receipt: {
      title: "Resi",
      deposit: "Depo USDT",
      ...
      close: "F\u00e8men",
      view: "Resi",
      loading: "Y ap chaje resi a...",
      error: "Pa ka chaje resi a",
    },
    virtualCard: {
      title: "Mastercard Vity\u00e8l",
      subtitle: "Aplike pou yon Mastercard vity\u00e8l pou f\u00e8 peman sou ent\u00e8n\u00e8t toupatou nan mond lan.",
      applyTitle: "Aplike pou kat",
      applyDescription: "Jwenn Mastercard vity\u00e8l ou a ak yon premye balans $4.00 pou yon total $19.00.",
      initialFunding: "Finansman inisyal (USD)",
      minFunding: "Minimom $19.99 USD",
      applyButton: "Aplike pou Mastercard",
      ...
      kycRequired: "Verifikasyon KYC obligatwa pou aplike pou yon Mastercard.",
      kycRequiredDesc: "Konplete verifikasyon KYC ou pou aplike pou Mastercard.",
      cardCreated: "Mastercard kreye avek sikse!",
      cardFunded: "Kat rechaje avek sikse!",
      frozen: "Jele",
      active: "Aktif",
      cardCost: "Pri kat la",
      yourBalance: "Balans ou",
      insufficientBalance: "Ou bezwen omwen $30 USDT nan kont ou pou aplike pou yon kat vity\u00e8l. Tanpri depoze lajan anvan.",
      maintenanceTitle: "Anba reparasyon",
      maintenanceDesc: "S\u00e8vis Mastercard la anba reparasyon kounye a. Tanpri eseye ank\u00f2 pita.",
    },
    faq: {
...
type TranslationSet = {
  nav: { dashboard: string; deposit: string; withdraw: string; profileKyc: string; adminPanel: string; signOut: string; cryptoToCash: string; faq?: string; virtualCard?: string; sendFunds?: string };
  ...
  receipt: { title: string; deposit: string; withdrawal: string; type: string; amount: string; fee: string; rate: string; amountHtg: string; network: string; walletAddress: string; destination: string; currency: string; name: string; date: string; transactionId: string; receiptId: string; status: string; completed: string; close: string; view: string; loading: string; error: string };
