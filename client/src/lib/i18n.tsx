...
const translations = {
  en: {
    ...
    virtualCard: {
      ...
      applyDescription: "Get a virtual Visa card funded from your USDT balance. Card costs $30 USD.",
      ...
      cardCost: "Card Cost",
      yourBalance: "Your Balance",
      insufficientBalance: "You need at least $30 USDT in your account to apply for a virtual card. Please deposit funds first.",
  ...
  fr: {
    ...
    virtualCard: {
      ...
      applyDescription: "Obtenez une carte Visa virtuelle financ\u00e9e depuis votre solde USDT. La carte co\u00fbte 30 $ USD.",
  ...
  ht: {
    ...
    virtualCard: {
      ...
      applyDescription: "Jwenn yon kat Visa vity\u00e8l ki finanse ak balans USDT ou. Kat la koute $30 USD.",
