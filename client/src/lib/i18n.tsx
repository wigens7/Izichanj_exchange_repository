...
const translations = {
  en: {
    ...
    virtualCard: {
      ...
      applyDescription: "Get your virtual Visa card with an initial $4.00 balance for a total of $19.00.",
  ...
  fr: {
    ...
    virtualCard: {
      ...
      applyDescription: "Obtenez votre carte Visa virtuelle avec un solde initial de 4,00 $ pour un total de 19,00 $.",
  ...
  ht: {
    ...
    virtualCard: {
      ...
      applyDescription: "Jwenn kat Visa vityèl ou a ak yon premye balans $4.00 pou yon total $19.00.",
