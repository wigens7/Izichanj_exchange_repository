...
const translations = {
  en: {
    ...
    virtualCard: {
      ...
      applyDescription: "Get a virtual Visa card funded from your USDT balance. Total cost includes a $15 activation fee plus a 3.4% network fee on the $20 initial load.",
  ...
  fr: {
    ...
    virtualCard: {
      ...
      applyDescription: "Obtenez une carte Visa virtuelle financée depuis votre solde USDT. Le coût total inclut des frais d'activation de 15 $ plus des frais réseau de 3,4 % sur le chargement initial de 20 $.",
  ...
  ht: {
    ...
    virtualCard: {
      ...
      applyDescription: "Jwenn yon kat Visa vityèl ki finanse ak balans USDT ou. Pri total la gen ladann yon frè aktivasyon $15 plis yon frè rezo 3,4% sou premye chajman $20 a.",
