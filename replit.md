...
## Recent Changes
- **Feb 12, 2026**: Enforced mandatory personal information before KYC verification. Added firstName, lastName, dateOfBirth, country, and city fields to profiles schema and Profile page. Users must complete these fields and save them before the KYC document upload section becomes active. Backend updated to validate personal info presence before accepting KYC submissions.
