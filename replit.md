...
- **Feb 16, 2026**: Replaced UltraMsg with Infobip for WhatsApp OTP delivery. Uses Infobip WhatsApp Text Message API. Env vars: INFOBIP_API_KEY, INFOBIP_BASE_URL, INFOBIP_WHATSAPP_SENDER.
